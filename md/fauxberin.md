...
　そんなこんなの2024年頃、Bobleyの書いていたソースコードが盗まれるという事件があった。詳しいことは分からないけど、クビになった開発者の中に後になって部外秘の開発中ソースコードを外部に流出させたアホが居たらしい。これについてはあまり踏み込まなかったのでそれが誰だったのかは分からないけど、私が知ってる名前じゃなかったら良いなあ。

　これも詳細は全く分からないけど、2025年には何か大きな開発方針の変更もあったようだ。5年以上かけたソースコードを盗まれてもまた改めてやり直すとか、もはやタングステンみたいな強靭メンタルで草枯れる。
...
- 分家はキャラクリ画面からでないと利用規約（ToS）が確認できない上に、その文面が将来的に隙あらば有料化する気が満々で反感を買った。
...
- **何故か分家に2024年に盗まれた開発中バージョンのソースコードにしか存在しない実装作業中の新機能のコードが多数、しかも未完成のまま入っていた。**
...
　全方位から袋叩きにされた彼は最終的に逆ギレからの荒らしムーブをぶちかました後に前述の『提案』を含むほとんどの自らの書き込みを消して逃亡し、後に分家のDiscordサーバを立ち上げた。ちなみに分家のDiscordサーバはちょっとでも本家の話題に触れるとBANというディストピア感マシマシのやべー鯖である。
...
　…まあ、そうなるよな。というかこの文面を考えた人は聖人か何かかな。こんなの私なら「shine boke」で済ませるぞ。Oberinの各地に大量の猫が居るのはこのためだったのかも知れないな。
